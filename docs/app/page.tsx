  ...
  return (
    <div className="flex sm:min-h-[87.5vh] min-h-[82vh] flex-col sm:items-center justify-center text-center sm:py-8 py-14">
      ...
      <h1 className="text-[1.80rem] leading-8 sm:px-8 md:leading-[4.5rem] font-bold mb-4 sm:text-6xl text-left sm:text-center">
        High-performance React state management with{" "}
        <span className="text-primary">fine-grained reactivity</span>
      </h1>
      <p className="mb-8 md:text-lg text-base max-w-[1200px] text-muted-foreground text-left sm:text-center">
        Mesa provides automatic dependency tracking and path-based subscriptions, 
        ensuring only the components that need updates actually re-render. 
        Zero dependencies, minimal bundle size, maximum performance.
      </p>
      ...
      <div className="hidden sm:grid grid-cols-3 gap-8 mt-16 max-w-4xl">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Just two functions: proxy() and useStore()
          </p>
        </div>
        <div className="text-center">
          <div className="text-2xl mb-2">⚡</div>
